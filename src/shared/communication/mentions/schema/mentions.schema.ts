...
export const mention = pgTable(
    "mention", {
        ...
        /**
         * Connects to the user account profile being mentioned. Purging this account cleanly wipes all corresponding
         * mention row records out of the table.
         */
        ...
        /**
         * Connects to the user account that authored the text content. Purging the author profile triggers a
         * cascading delete sweeping row indices out.
         */
    ...
    (table) => [
        // Accelerates cleanup sweeps and module tracking queries pulling rows matching content objects
        index("mention_module_record_idx")
            .on(table.module, table.recordId),

        // Speeds up user dashboard query notifications filtering by the targeted user's ID
