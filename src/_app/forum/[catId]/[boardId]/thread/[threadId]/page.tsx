...
import {CreateReplyPanel} from "@/_feature/forum/components/create-reply-panel";
import {replyToThreadAction} from "@/_feature/forum/lib/actions";
import {getThreadWithPosts} from "@/_feature/forum/lib/queries";
...
export default async function ForumThreadPage({params}: PageProps): Promise<JSX.Element> {
    ...
    return (
        <div>
            <_breadcrumbLabel segment={threadId}
