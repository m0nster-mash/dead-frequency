...
import {BoardDisplay} from "@/_feature/forum/components/board-display";
import {ForumStatsPanel} from "@/_feature/forum/components/forum-stats-panel";
import {getCategoryWithBoards} from "@/_feature/forum/lib/queries";
...
export default async function ForumCategoryPage({params}: PageProps): Promise<JSX.Element> {
    ...
    return (
        <div>
            <_breadcrumbLabel segment={catId}
