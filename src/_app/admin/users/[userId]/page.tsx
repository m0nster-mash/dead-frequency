import {AdminPostingStatusForm} from "@/_core/admin/components/admin-posting-status-form";
import {applyPostingStatusAction} from "@/_core/admin/lib/actions";
import {requireSession} from "@/_core/auth/lib/require-session";
import {requireUser} from "@/_core/auth/lib/require-user";
...
import formStyle from "@/_shared/styles/form.module.css";
...
export default async function AdminUserDetailsPage({params}: PageProps): Promise<JSX.Element> {
    ...
    return (
        <div>
            <_breadcrumbLabel segment={userId} label={user.name ?? undefined}/>
