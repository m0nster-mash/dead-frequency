import {SidebarProvider} from "@/_app/dashboard/components/sidebar-context";
import {_sidebar} from "@/_core";
import {JSX, ReactNode} from "react";
import _appShellFrame from "./_app-shell-frame";
...
export function AppShell({children}: AppShellProps): JSX.Element {
    return (
        <SidebarProvider>
            ...
            <_appShellFrame sidebar={<_sidebar/>} header={<_header/>}>
                {children}
            </_appShellFrame>
        </SidebarProvider>
    );
