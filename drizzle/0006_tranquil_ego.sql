...
CREATE TYPE "public"."module_name" AS ENUM('forum', 'chatbox', 'chatroom', 'dm', 'avatar_elements', 'blog', 'comment');--> statement-breakpoint
...
CREATE TABLE "user_role" (
	...
	"context_id" text,
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "user_role_user_id_role_id_context_id_pk" PRIMARY KEY("user_id","role_id","context_id")
);
--> statement-breakpoint
